...
Этапы 1, 2, 3 – **проверены на живом телефоне**. Этап 5 (шифрование + замок чтения) –
**код готов и статически проверен** (сборка + 39 JVM-тестов + lint + многоагентное
adversarial-ревью), но **ещё НЕ проверен на живом телефоне** – телефон отключился во
время теста. Осталось device-verify этапа 5: разделы «Проверка этапа 5 на телефоне» ниже.
...
### Проверка этапа 5 на телефоне (ОСТАЛОСЬ СДЕЛАТЬ)
