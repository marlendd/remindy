...
**Device-verify самого редизайна ещё предстоит** (детали – раздел «Редизайн UX» ниже).
...
### Редизайн UX (device-verify ПРЕДСТОИТ)
...
Проверить на телефоне (обе темы – переключить системную):
